...
const recttop = document.getElementById("diameter").getBoundingClientRect();
...
let g_diameter = 1.0;
let g_exposure = 10.0;
let g_focal_length = 1.0;

function OnSetDiameter()
{
	let elem = document.getElementById("diameter");
	g_diameter = elem.value;
	draw();
}

function OnSetFocalLength()
{
	let elem = document.getElementById("focallength");
	g_focal_length = elem.value;
	draw();
}
...
let elem = document.getElementById("exposure");
elem.value = g_exposure + "s";
